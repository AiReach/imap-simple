...
export interface Attachment {
  ...
  headers: any; // a Map value that holds MIME headers for the attachment node
  content: Buffer; // a Buffer that contains the attachment contents
  contentId: string | number; // the header value from ‘Content-ID’ (if present)
  cid: string | number; // contentId without < and >
